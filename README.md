...
📚 **Technical Guide**: For deep integration details, reverse-engineered Google credentials, protocol mappings, and custom CLI settings, read the [Unified Technical Guide](docs/TECHNICAL_GUIDE.md).
